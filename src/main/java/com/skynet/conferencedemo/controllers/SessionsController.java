...
import com.skynet.conferencedemo.repositories.SessionRepository;
...
public class SessionsController {
    ...
    @PostMapping
    public Session create(@RequestBody final Session session, @RequestHeader(name = "Content-Type") String contentType){
